...
class Level:
    ...
    def update(self, surface, keys):
        ...
        if self.player.dead:
            if self.player.rect.y > self.game_window.height:
                self.finished = True
    ...
    def check_x_collisions(self):
        check_group = pygame.sprite.Group(self.ground_items_group, self.bricks_group, self.box_group)
    ...
    def check_y_collisions(self):
        check_group = pygame.sprite.Group(self.ground_items_group, self.bricks_group,self.box_group)
        collieded_sprite = pygame.sprite.spritecollideany(self.player, check_group)
        if collieded_sprite:
            self.adjust_player_y(collieded_sprite)

...
class Info:
    ...
    def create_state_labels(self):
        ...
        if self.state == 'main_menu':
            self.state_labels.append((self.create_label('1 SPIELER GAME'),(272,360)))
            self.state_labels.append((self.create_label('2 SPIELER GAME'), (272,405)))
            ...
            self.state_labels.append((self.create_label('WELT'), (280, 200)))
            ...
            self.state_labels.append((self.create_label('GAME_OVER'),(280,300)))

    def create_info_labels(self):
        self.info_labels = []
        self.info_labels.append((self.create_label('MARIO'),(75,30)))
        self.info_labels.append((self.create_label('WELT'), (470, 30)))
        self.info_labels.append((self.create_label('ZEIT'), (625, 30)))
